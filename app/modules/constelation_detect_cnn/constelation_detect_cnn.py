"""
Script: cponstellation_detect_cnn.py
Autor: Covaci Silviu
Colaboratori: Hajdu Hunor
Descriere: Acest cod integrează un model CNN pentru detectarea constelațiilor din imagini, construit și antrenat de Hajdu Hunor. 
